...
export default function Part1UpdatingObjects() {
  ...
  const updateNameWrong = () => {
    ...
    setUser(user);
    // Although this does change the object, this wont update our page because the original reference object
    // is passed in, and React thinks you didn't change it (since objects are mutable)
  };

  const updateNameRight = () => {
    console.log("RIGHT: create new user object");
    // spread is only a shallow copy of the array
