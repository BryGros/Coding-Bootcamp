...
// take in password as parameter
async function demonstrateHashing(password) {
  // on the bcrypt object, there is a function called "hash," which takes in a password along with the salt/Rounds
  ...
  // even though the hashes are different, we can use the compare function to check if they come from the same source password
